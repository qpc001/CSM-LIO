...
#ifndef CSMLIO_MAPPING_INTERNAL_RANGE_DATA_COLLATOR_H_
#define CSMLIO_MAPPING_INTERNAL_RANGE_DATA_COLLATOR_H_
...
class RangeDataCollator {
  ...
  private:
    ...
    constexpr static float kDefaultIntensityValue = 1.0f;
};

}  // namespace mapping
}  // namespace csmlio

#endif  // CSMLIO_MAPPING_INTERNAL_RANGE_DATA_COLLATOR_H_
